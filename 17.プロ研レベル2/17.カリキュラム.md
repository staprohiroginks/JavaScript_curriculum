...
<!-- 折り畳み展開ポインタ -->
 <div onclick="obj=document.getElementById('9').style; obj.display=(obj.display=='none')?'block':'none';">
    ...
    自由に記述してください。-->
<h2>②</h2>
<br><iframe width="900" height="600" src="https://www.youtube.com/embed/HeP7YdOHrzE?si=oucOPvwZ1WvuroQ6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
<hr>
...
<!-- 折り畳み展開ポインタ -->
 <div onclick="obj=document.getElementById('45').style; obj.display=(obj.display=='none')?'block':'none';">
    ...
    自由に記述してください。-->
<h2>①</h2><br>
<iframe width="900" height="600" src="https://www.youtube.com/embed/QUz570pDuBM?si=sTiIjh8S2q6cVZE4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<!-- 折り畳み展開ポインタ -->
 <div onclick="obj=document.getElementById('46').style; obj.display=(obj.display=='none')?'block':'none';">
    ...
    自由に記述してください。-->
<h2>②</h2><br>
<iframe width="900" height="600" src="https://www.youtube.com/embed/TkTG328SeWc?si=g2DbNR_syu7W6T_G" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<!-- 折り畳み展開ポインタ -->
 <div onclick="obj=document.getElementById('47').style; obj.display=(obj.display=='none')?'block':'none';">
    ...
    自由に記述してください。-->
<h2>③</h2><br>
<iframe width="900" height="600" src="https://www.youtube.com/embed/Z3AD06jFqu4?si=zg9eF884nJAb6OpL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<!-- 折り畳み展開ポインタ -->
 <div onclick="obj=document.getElementById('48').style; obj.display=(obj.display=='none')?'block':'none';">
    ...
    自由に記述してください。-->
<h2>②</h2><br>
<iframe width="900" height="600" src="https://www.youtube.com/embed/3zyMio-VmdM?si=1olcXiJH387QvHit" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
<hr>
...
<!-- 折り畳み展開ポインタ -->
 <div onclick="obj=document.getElementById('49').style; obj.display=(obj.display=='none')?'block':'none';">
    ...
    自由に記述してください。-->
<h2>③</h2><br>
<iframe width="900" height="600" src="https://www.youtube.com/embed/WLi4BzwVLjk?si=PzWd3-mYLgsB6y_4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<!-- 折り畳み展開ポインタ -->
 <div onclick="obj=document.getElementById('50').style; obj.display=(obj.display=='none')?'block':'none';">
    ...
    自由に記述してください。-->
<h2>④</h2>
<br><iframe width="900" height="600" src="https://www.youtube.com/embed/CPwXey-qxwg?si=neoYL_XrsULn2RRo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
<hr>
